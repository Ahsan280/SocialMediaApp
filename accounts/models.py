...
class UserFollower(models.Model):
    ...
    following=models.ForeignKey(Account, on_delete=models.CASCADE, null=True, related_name="being_followed")
...
class UserFollowing(models.Model):
    following=models.ForeignKey(Account, on_delete=models.CASCADE, null=True)
...
class UserProfile(models.Model):
    user=models.ForeignKey(Account, on_delete=models.CASCADE, related_name='user_profile')
